...
import 'package:mob_2/viewmodels/email_verification_notice_view_model.dart';
...
class _EmailVerificationNoticeScreenState
  ...
  late final EmailVerificationNoticeViewModel _viewModel;

  @override
  void initState() {
    super.initState();
    _viewModel = EmailVerificationNoticeViewModel(widget.email);
  }
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: _viewModel.resending
                                    ? null
                                    : _resend,
